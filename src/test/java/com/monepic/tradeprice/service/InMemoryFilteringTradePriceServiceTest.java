...
public class InMemoryFilteringTradePriceServiceTest {

    private InMemoryFilteringTradePriceService service;

    @BeforeEach
    void init() {
        service = new InMemoryFilteringTradePriceService(30);
